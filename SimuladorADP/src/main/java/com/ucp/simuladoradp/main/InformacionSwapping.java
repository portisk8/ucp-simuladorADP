 ...
 * @author Facun
 */
public class InformacionSwapping extends javax.swing.JFrame {

    /**
     * Creates new form InformacionSwapping
     */
    public InformacionSwapping() {
              initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Swapping");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionSwapping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionSwapping().setVisible(true);
            }
        });
    }
