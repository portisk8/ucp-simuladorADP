...
public class FIFO extends Algoritmo {
    ...
    public FIFO(String nombre, String caracteristicas, String ventaja, ArrayList<Proceso> procesos, VentanaSimulacion view){
    ...
    public FIFO(String nombre, String caracteristicas, String ventaja){
        super(nombre, caracteristicas, ventaja);
        this.setProcesos(new ArrayList<Proceso>());
    }
    ...
    public void run(CuadroComparacion cuadro) {
            ...
            cuadro.getFifoArea().setText(mostrar);
            super.resetProcesos();
     }
}